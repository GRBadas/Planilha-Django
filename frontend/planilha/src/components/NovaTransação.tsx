  ...
  return (
    ...
    <div className="max-w-4xl mx-auto p-10 bg-zinc-700 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="w-full py-2 px-4 bg-violet-600 text-white font-semibold rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          Adicionar Transação
        </button>
      </form>
